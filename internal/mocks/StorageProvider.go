...
func (_m *StorageProvider) BulkSaveURL(ctx context.Context, data *[]models.InsertData) error {
...
func (_m *StorageProvider) SaveURL(ctx context.Context, fullURL string, shortURL string) error {
